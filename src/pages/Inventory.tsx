...
// Physical stock audit as on 18.07.2026 (from client's STOCK UPDATE.xlsx)
const INITIAL_STOCK: StockItem[] = [
  { sl:1, name:'CALYPSO CHIC SILVER', unit:'Ltr', packSize:'1 Ltr', godownQty:1, godownKg:1, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:2, name:'CALYPSO CHIC ZECCHINO GOLD', unit:'Ltr', packSize:'1 Ltr', godownQty:1, godownKg:1, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:3, name:'CERACAP CHIC NEUTRAL', unit:'Ltr', packSize:'1 Ltr', godownQty:9, godownKg:9, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:4, name:'CERACAP GOLD', unit:'Ltr', packSize:'1 Ltr', godownQty:11, godownKg:11, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:5, name:'CERACAP SILVER', unit:'Ltr', packSize:'1 Ltr', godownQty:16, godownKg:16, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:6, name:'CHARME VELVET', unit:'Ltr', packSize:'1 Ltr', godownQty:5, godownKg:5, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:7, name:'CLOTH', unit:'Ltr', packSize:'1 Ltr', godownQty:0, godownKg:0, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:8, name:'COLOURS NO 1', unit:'Ltr', packSize:'1 Ltr', godownQty:3, godownKg:3, seaAirQty:12, seaAirKg:12, dispatch:0, productReturn:0 },
  { sl:9, name:'COLOURS NO 10', unit:'Ltr', packSize:'1 Ltr', godownQty:3, godownKg:3, seaAirQty:6, seaAirKg:6, dispatch:0, productReturn:0 },
  { sl:10, name:'COLOURS NO 11', unit:'Kg', packSize:'1 Kg', godownQty:10, godownKg:10, seaAirQty:10, seaAirKg:10, dispatch:0, productReturn:0 },
  { sl:11, name:'COLOURS NO 12', unit:'Ltr', packSize:'1 Ltr', godownQty:3, godownKg:3, seaAirQty:6, seaAirKg:6, dispatch:0, productReturn:0 },
  { sl:12, name:'COLOURS NO 13', unit:'Ltr', packSize:'1 Ltr', godownQty:1, godownKg:1, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:13, name:'COLOURS NO 14', unit:'Ltr', packSize:'1 Ltr', godownQty:0, godownKg:0, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:14, name:'COLOURS NO 15', unit:'Ltr', packSize:'1 Ltr', godownQty:1, godownKg:1, seaAirQty:6, seaAirKg:6, dispatch:0, productReturn:0 },
  { sl:15, name:'COLOURS NO 16', unit:'Ltr', packSize:'1 Ltr', godownQty:1, godownKg:1, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:16, name:'COLOURS NO 2', unit:'Ltr', packSize:'1 Ltr', godownQty:0, godownKg:0, seaAirQty:12, seaAirKg:12, dispatch:0, productReturn:0 },
  { sl:17, name:'COLOURS NO 3', unit:'Ltr', packSize:'1 Ltr', godownQty:0, godownKg:0, seaAirQty:12, seaAirKg:12, dispatch:0, productReturn:0 },
  { sl:18, name:'COLOURS NO 4', unit:'Ltr', packSize:'1 Ltr', godownQty:4, godownKg:4, seaAirQty:6, seaAirKg:6, dispatch:0, productReturn:0 },
  { sl:19, name:'COLOURS NO 5', unit:'Ltr', packSize:'1 Ltr', godownQty:2, godownKg:2, seaAirQty:6, seaAirKg:6, dispatch:0, productReturn:0 },
  { sl:20, name:'COLOURS NO 6', unit:'Ltr', packSize:'1 Ltr', godownQty:2, godownKg:2, seaAirQty:6, seaAirKg:6, dispatch:0, productReturn:0 },
  { sl:21, name:'COLOURS NO 7', unit:'Ltr', packSize:'1 Ltr', godownQty:1, godownKg:1, seaAirQty:6, seaAirKg:6, dispatch:0, productReturn:0 },
  { sl:22, name:'COLOURS NO 8', unit:'Ltr', packSize:'1 Ltr', godownQty:0, godownKg:0, seaAirQty:12, seaAirKg:12, dispatch:0, productReturn:0 },
  { sl:23, name:'COLOURS NO 9', unit:'Ltr', packSize:'1 Ltr', godownQty:4, godownKg:4, seaAirQty:12, seaAirKg:12, dispatch:0, productReturn:0 },
  { sl:24, name:'CONCRETE CAP', unit:'Kg', packSize:'20 Kg', godownQty:7, godownKg:140, seaAirQty:5, seaAirKg:125, dispatch:0, productReturn:0 },
  { sl:25, name:'DAMASK', unit:'Ltr', packSize:'1 Ltr', godownQty:6, godownKg:6, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:26, name:'DECOR PROTECTIVE', unit:'Ltr', packSize:'1 Ltr', godownQty:1, godownKg:1, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:27, name:'DECOR STUCCO', unit:'Kg', packSize:'25 Kg', godownQty:1, godownKg:25, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:28, name:'DUNE', unit:'Ltr', packSize:'1 Ltr', godownQty:0, godownKg:0, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:29, name:'ESSENTIA SILVER', unit:'Ltr', packSize:'2.5 Ltr', godownQty:31, godownKg:47.5, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:30, name:'GEM', unit:'Ltr', packSize:'1 Ltr', godownQty:2, godownKg:2, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:31, name:'GRASSELLO', unit:'Kg', packSize:'20 Kg', godownQty:1, godownKg:20, seaAirQty:10, seaAirKg:200, dispatch:0, productReturn:0 },
  { sl:32, name:'INDURITORE', unit:'ML', packSize:'500 ML', godownQty:0, godownKg:0, seaAirQty:60, seaAirKg:30, dispatch:0, productReturn:0 },
  { sl:33, name:'KALAHARI', unit:'Ltr', packSize:'1 Ltr', godownQty:8, godownKg:8, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:34, name:'KIMERA', unit:'Ltr', packSize:'1 Ltr', godownQty:1, godownKg:1, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:35, name:'LAND', unit:'Ltr', packSize:'1 Ltr', godownQty:1, godownKg:1, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:36, name:'MAHARAJA ARGENTO', unit:'Ltr', packSize:'1 Ltr', godownQty:14, godownKg:14, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:37, name:'MAHARAJA BLU', unit:'Ltr', packSize:'1 Ltr', godownQty:8, godownKg:8, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:38, name:'MAHARAJA NEUTRO', unit:'Ltr', packSize:'1 Ltr', godownQty:7, godownKg:7, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:39, name:'MAHARAJA ORO', unit:'Ltr', packSize:'1 Ltr', godownQty:14, godownKg:14, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:40, name:'MAHARAJA VERDE', unit:'Ltr', packSize:'1 Ltr', godownQty:13, godownKg:13, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:41, name:'MANIA PEARLA', unit:'Ltr', packSize:'2.5 Ltr', godownQty:9, godownKg:18, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:42, name:'MANIA SILVER', unit:'Ltr', packSize:'1 Ltr', godownQty:17, godownKg:17, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:43, name:'MANIA ZECCHINO GOLD', unit:'Ltr', packSize:'1 Ltr', godownQty:15, godownKg:15, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:44, name:'MARMARINO', unit:'Kg', packSize:'20 Kg', godownQty:20, godownKg:400, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:45, name:'MARMO VENEZIANO', unit:'Kg', packSize:'20 Kg', godownQty:1, godownKg:20, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:46, name:'MICROLITE 100', unit:'Kg', packSize:'20 Kg', godownQty:0, godownKg:0, seaAirQty:56, seaAirKg:1120, dispatch:0, productReturn:0 },
  { sl:47, name:'MICROLITE 300', unit:'Kg', packSize:'4 Kg', godownQty:1, godownKg:4, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:48, name:'MICROLITE 500', unit:'Kg', packSize:'20 Kg', godownQty:0, godownKg:0, seaAirQty:80, seaAirKg:1600, dispatch:0, productReturn:0 },
  { sl:49, name:'MINERAL BRONZE', unit:'Ltr', packSize:'1 Ltr', godownQty:5, godownKg:5, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:50, name:'MINERAL SILVER', unit:'Ltr', packSize:'2.5 Ltr', godownQty:2, godownKg:5, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:51, name:'MOTHER OF PEARL', unit:'Ltr', packSize:'1 Ltr', godownQty:2, godownKg:2, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:52, name:'OXIDCAP ATTIVATOR', unit:'ML', packSize:'500 ML', godownQty:4, godownKg:2, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:53, name:'OXIDCAP FINITURA', unit:'Ltr', packSize:'1 Ltr', godownQty:3, godownKg:3, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:54, name:'OXIDCAP FONDO', unit:'Ltr', packSize:'1 Ltr', godownQty:2, godownKg:2, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:55, name:'OXYAGED ACTIVATOR', unit:'Ltr', packSize:'1 Ltr', godownQty:2, godownKg:2, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:56, name:'OXYAGED FINITURA', unit:'Ltr', packSize:'1 Ltr', godownQty:3, godownKg:3, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:57, name:'OXYAGED FONDO', unit:'Ltr', packSize:'1 Ltr', godownQty:3, godownKg:3, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:58, name:'PATTI BLADE', unit:'Ltr', packSize:'1 Ltr', godownQty:0, godownKg:0, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:59, name:'PEARL', unit:'Ltr', packSize:'1 Ltr', godownQty:1, godownKg:1, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:60, name:'PUNTINATO', unit:'Kg', packSize:'20 Kg', godownQty:13, godownKg:222, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:61, name:'ROLLER BRUSH', unit:'Ltr', packSize:'1 Ltr', godownQty:0, godownKg:0, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:62, name:'SILOXCAP', unit:'Kg', packSize:'20 Kg', godownQty:2, godownKg:40, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:63, name:'SILVELATURA', unit:'Ltr', packSize:'14 Ltr', godownQty:2, godownKg:28, seaAirQty:5, seaAirKg:70, dispatch:0, productReturn:0 },
  { sl:64, name:'SKIN SOFT TOUCH', unit:'Ltr', packSize:'1 Ltr', godownQty:1, godownKg:1, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:65, name:'STONEART', unit:'Ltr', packSize:'4 Ltr', godownQty:5, godownKg:20, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:66, name:'STONEART (25 KG)', unit:'Kg', packSize:'25 Kg', godownQty:2, godownKg:50, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:67, name:'TAPE', unit:'Ltr', packSize:'1 Ltr', godownQty:0, godownKg:0, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:68, name:'TECH COAT PRO', unit:'Ltr', packSize:'4 Ltr', godownQty:0, godownKg:0, seaAirQty:29, seaAirKg:116, dispatch:0, productReturn:0 },
  { sl:69, name:'TEXO COMPOUND', unit:'Kg', packSize:'35 Kg', godownQty:0, godownKg:0, seaAirQty:0, seaAirKg:0, dispatch:0, productReturn:0 },
  { sl:70, name:'TRAVERTINO', unit:'Kg', packSize:'20 Kg', godownQty:2, godownKg:40, seaAirQty:35, seaAirKg:700, dispatch:0, productReturn:0 },

    ...
    <div className="space-y-5 max-w-3xl">
      ...
      <div className="card">
        <div className="flex items-center gap-3 mb-5">
          <div className="p-2 bg-brand-gold/10 rounded-lg"><Building2 size={17} className="text-brand-gold"/></div>
      ...
      <div className="card">
        <div className="flex items-center gap-3 mb-5">
          <div className="p-2 bg-brand-gold/10 rounded-lg"><Bell size={17} className="text-brand-gold"/></div>
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={n.l} className="flex items-center justify-between py-3 border-b border-brand-border last:border-0">
              <div><p className="text-sm font-medium text-gray-200">{n.l}</p><p className="text-xs text-gray-600 mt-0.5">{n.d}</p></div>
              <label className="relative inline-flex cursor-pointer">
                <input type="checkbox" defaultChecked className="sr-only peer"/>
                <div className="w-10 h-5 bg-brand-border peer-checked:bg-brand-gold rounded-full transition-colors peer-focus:ring-2 peer-focus:ring-brand-gold/30"/>
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-brand-gold/10 rounded-lg"><Users size={17} className="text-brand-gold"/></div>
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={u.email} className="flex items-center gap-3 p-3 bg-white/[0.03] border border-brand-border rounded-xl">
              <div className="w-8 h-8 rounded-full bg-brand-gold flex items-center justify-center text-black text-xs font-bold">{u.name[0]}</div>
      ...
      <div className="card">
        <div className="flex items-center gap-3 mb-5">
          <div className="p-2 bg-brand-gold/10 rounded-lg"><Lock size={17} className="text-brand-gold"/></div>
